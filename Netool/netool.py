...
#────────────────────────────────────────────────────────────────────────────────────────────────────────────
    def get_OpenPorts(c,t,m): # -----------------------------[     OPEN PORTS      ]--------------------
        port_dict = {
            ...
            1745:'Winsock-proxy',               2000:'Remotely Anywhere',                           2001:'Cisco device management, Remotely Anywhere',
            2301:'Compaq Insight Manager',      2381:'Secure Cpq Insight Manager',                  3389:'Terminal Services',
            4001:'Cisco device management',     5631:'PC Anywhere'
            }
